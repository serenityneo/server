/**
 * DATABASE MIGRATION: Partner KYC Completion & Card Management
 * 
 * This migration creates/updates tables for:
 * 1. Partner KYC Completion System (with authorization & locking)
 * 2. Card Cancellation/Renewal Requests (partner & customer)
 * 3. Extends existing card_requests table for partner support
 * 
 * Professional banking-grade implementation with:
 * - Full audit trail
 * - Authorization & lock mechanisms
...
async function createPartnerKycAndCardTables() {
  try {
    console.log('🚀 Starting database migration...\n');

    // ============================================================================
    // TABLE 1: PARTNER KYC COMPLETIONS
    // ============================================================================
    console.log('🔧 Creating partner_kyc_completions table...');

    await pool.query(`
      -- Table for tracking partner KYC completion requests with full authorization
    ...
    // ============================================================================
    // TABLE 2: EXTEND EXISTING CARD_REQUESTS FOR PARTNER SUPPORT
    // ============================================================================
    console.log('🔧 Adding partner support to existing card_requests table...');
    ...
    await pool.query(`
      ...
      -- Create indexes for partner requests
    ...
    console.log('✅ card_requests table extended for partner support!\n');

    // ============================================================================
    // TABLE 3: CARD CANCELLATION/RENEWAL REQUESTS
    // ============================================================================
    console.log('🔧 Creating card_cancellation_requests table...');

    await pool.query(`
      -- Table for card cancellation/renewal requests (supports both customer & partner requests)
      ...
      -- Auto-update trigger (reuse function from partner_kyc_completions)
      DROP TRIGGER IF EXISTS trigger_update_card_cancellation_requests_updated_at ON card_cancellation_requests;
